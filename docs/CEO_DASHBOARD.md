...
**現在：TESTING工程（CEOによる実機テスト中）**

以下のテストを実行し、完了したらチェックを入れてください。
バグや仕様不備が見つかった場合は、チェックせずに報告してください。

**Task 401: 基本機能テスト**
- [ ] 「頭痛薬を飲んだ」ボタンで記録できる
- [ ] 「今月の服用回数」が正しくカウントアップされる

**Task 402: Free/Premium境界テスト**
- [ ] Free版：平均間隔がロックアイコンで表示される
- [ ] Free版：統計グラフがロックされている
- [ ] Premium版（Debug機能）：機能がアンロックされる

**Task 403 & 405: 履歴・エッジケース**
- [ ] 履歴リストに日時が正しく表示される
- [ ] 記録0件の時「記録がありません」等が表示される
- [ ] 記録1件の時、平均間隔が計算される（DEC-02仕様）
